...
const InvestmentAndDebunturetwoPage = () => {
  ...
  useEffect(() => {
    getHeadersService("/scr_supp_h2_investment_and_debenture").then((res) => {
      setHeaders(res || []);
    });
  }, []);
  const fetchServices = () => {
    getScreensData(
      "/scr_supp_h2_investment_and_debenture",
      glPeriod,
      page + 1,
      rowsPerPage
    ).then((res) => {
...
export default InvestmentAndDebunturetwoPage;
