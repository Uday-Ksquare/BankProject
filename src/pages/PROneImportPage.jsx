...
const PROneImportPage = () => {
  ...
  useEffect(() => {
    getScreensData("/scr_pr01import",reportType,glPeriod, pageNumber, pageSize).then(
      (res) =>
        setData({
          screens: res.screens || [],
  ...
  }, [pageNumber, pageSize, reportType, glPeriod]);
...
export default PROneImportPage;
