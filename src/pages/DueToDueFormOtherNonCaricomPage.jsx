                  ...
                  {row.detalles.map((child, i) => (
                    <TableRow key={i}>
                      ...
                      <TableCell sx={cellStyles} align="right">
                        ...
                        >
                          {formatFinancial(child?.allColumns[0]?.columnValue)}
                          {/* {row?.allColumns[0]?.columnValue} */}
                          {/* {formatIndianNumber(
                      ...
                      <TableCell sx={cellStyles} align="right">
                        ...
                        >
                          ...
                          {/* {row?.allColumns[1]?.columnValue} */}
                          {formatFinancial(child?.allColumns[1]?.columnValue)}
                        </div>
                      </TableCell>
...
const DueToDueFormOtherNonCaricomPage = () => {
  ...
  const fetchCdssList = (pageNumber = 0, pageSize = 10) => {
    axios
      .get(
        `http://34.51.85.243:8080/api/dynamic/screens/scr_supp_c_due_to_and_due_from_other_non_caricom/202502?pageNumber=${
          pageNumber + 1
        }&pageSize=${pageSize}`
      )
      .then((response) => {
...
export default DueToDueFormOtherNonCaricomPage;
